...
*/
{
  ...
  int i;
  cout << "Sorting already sorted list with Bubble Sort" << endl;
  Key::comparisons = 0;
  the_list.clear();
  ...
  the_list.traverse(print);
  cout << endl << endl;
  print_out("Sorted Bubble", Key::comparisons, 1);
  cout << endl << endl;
  cout << "Sorting reverse sorted list with Bubble Sort" << endl;
  Key::comparisons = 0;
  the_list.clear();
  for (i = 0; i < list_size; i++)
  ...
  the_list.traverse(print);
  cout << endl << endl;
  print_out("Reverse Sorted Bubble", Key::comparisons, 1);
  cout << endl << endl;
  cout << "Sorting random lists with Bubble Sort" << endl;
  Key::comparisons = 0;
  ...
  print_out("Random list Bubble", Key::comparisons, sorts);
  cout << endl << endl;
}

...
*/
{
  ...
  int i;
  cout << "Sorting already sorted list with Merge Sort" << endl;
  Key::comparisons = 0;
  the_list.clear();
  ...
  the_list.traverse(print);
  cout << endl << endl;
  print_out("Sorted Merge", Key::comparisons, 1);
  cout << endl << endl;
  cout << "Sorting reverse sorted list with Merge Sort" << endl;
  Key::comparisons = 0;
  the_list.clear();
  for (i = 0; i < list_size; i++)
  ...
  the_list.traverse(print);
  cout << endl << endl;
  print_out("Reverse Sorted Merge", Key::comparisons, 1);
  cout << endl << endl;
  cout << "Sorting random lists with Merge Sort" << endl;
  Key::comparisons = 0;
  ...
  print_out("Random list Merge", Key::comparisons, sorts);
  cout << endl << endl;
}

...
*/
{
  ...
  int i;
  cout << "Sorting already sorted list with Quick Sort" << endl;
  Key::comparisons = 0;
  the_list.clear();
  ...
  the_list.traverse(print);
  cout << endl << endl;
  print_out("Sorted Quick", Key::comparisons, 1);
  cout << endl << endl;
  cout << "Sorting reverse sorted list with Quick Sort" << endl;
  Key::comparisons = 0;
  the_list.clear();
  for (i = 0; i < list_size; i++)
  ...
  the_list.traverse(print);
  cout << endl << endl;
  print_out("Reverse Sorted Quick", Key::comparisons, 1);
  cout << endl << endl;
  cout << "Sorting random lists with Quick Sort" << endl;
  Key::comparisons = 0;
  ...
  print_out("Random list Quick", Key::comparisons, sorts);
  cout << endl << endl;
}
